<template>
  <div class="boxBg">
    <el-row>
      <div style="font-size: 72px;color:#ff6497; text-align: center;padding-top: 10px;">
  ...
  export default {
    ...
    mounted() {
      ...
      this.$http.post('/webresources/login/ship/ShipTopStatic/msckb1/find', this.hdQuery).then(response => {
        ...
        this.data = [{name: '散货', value: parseInt(data.monCargWgSh/1000)/10}, {name: '件杂货', value: parseInt(data.monCargWgZh/1000)/10}]
      })
    },
    computed: {
      total: function () {
